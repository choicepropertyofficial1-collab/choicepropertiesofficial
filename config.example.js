...
CONFIG.img = function(url, preset) {
  ...
  const transforms = {
    ...
    card_2x:     'tr:w-1200,q-80,f-webp',     // retina card srcset
    gallery:     'tr:w-1200,q-90,f-webp',
    gallery_2x:  'tr:w-2400,q-85,f-webp',       // retina hero / lightbox srcset
    strip:       'tr:w-80,h-60,c-maintain_ratio,q-70,f-webp',  // thumbnail strip in gallery
...
// ── srcset helper — returns "1x_url 1x, 2x_url 2x" for retina displays ──
// Usage: srcset="${CONFIG.srcset(url, 'card', 'card_2x')}"
